...
const MyProfile = ({ inputs, title }) => {
    ...
    const onSubmit = async data => {
        ...
        // fetch('https://stark-retreat-48209.herokuapp.com/createProfile', {
        //     method: 'POST',
        //     headers: {
        ...
        //     })
        fetch(`https://stark-retreat-48209.herokuapp.com/createProfile/${user.email}`, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
    ...
    const { data: services, isLoading, refetch } = useQuery(['userProfile', user?.email], () => fetch(`https://stark-retreat-48209.herokuapp.com/userProfile/${user?.email}`, {
        method: 'GET',
        headers: {
            'authorization': `Bearer ${localStorage.getItem('accessToken')}`
        }
